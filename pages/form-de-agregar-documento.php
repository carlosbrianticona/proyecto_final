...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $consultaId = "SELECT Descripcion FROM tipo_documento WHERE Descripcion = ?";
    ...
    if ($resultado->num_rows > 0) {
        ...
        $sql = "INSERT INTO tipo_documento (Descripcion) VALUES (?)";
        ...
        if ($stmt->execute()) {
            echo "<script>
                    ...
                    window.location.href = 'tabla-tipo-de-documento.php';
                </script>";
        } else {
...
<header>
    ...
    <form class="row g-3 mt-3" name="formularioAgregar" method="POST" autocomplete="off" action="./form-de-agregar-documento.php">
        <div class="col-md-12">
            <label for="agregar" class="form-label">Agregar tipo de documento</label>
            <input type="text" name="documento" class="form-control" id="agregar" value="" required>
        </div>
        <div class="col-md-6">
            <button type="submit" class="btn btn-danger mt-3 col-md-12">Agregar</button>
        </div>
        <div class="col-md-6">
            <a href="./tabla-tipo-de-documento.php" class="btn btn-warning mt-3 col-md-12">Volver</a>
        </div>
    </form>
