                ...
                <div class="col-md-8">
                    ...
                    <form class="row g-3 mt-3" name="nuevo socio" method="POST" autocomplete="off" action="../php/registro_reserva.php">  <!--aqui abre el form-->
                        ...
                        <label for="numero" class="form-label">Número</label>
                                <label for="numero" class="form-label">(de 7 a 11 digitos)</label>
                                <input type="text" name="nr_documento" pattern="[0-9]+" class="form-control" id="numero" placeholder="Nº" minlength="7" maxlength="11" required>
                            <div class="error-message text" style="display:none; color:white;"></div>
                        </div>
                        <div class="col-md-4 mt-3">
