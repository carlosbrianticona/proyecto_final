        ...
        function eliminarDocumento(id) {
            if (confirm('¿Estás seguro de que deseas eliminar este tipo de documento?')) {
                ...
                $.ajax({
                    ...
                    data: { id: id },
                    dataType: 'json', // Asegura que jQuery maneje la respuesta como JSON
                    ...
                    error: function(xhr, status, error) {
                        ...
                        alert('Error al eliminar el tipo de documento: No se puede eliminar este tipo de documento porque está asociado a personas.');
                    }
                });
            }
        }
